...
#aet bitwidth 8
read_file -f ddc ../pe_prct/designs/PE.ddc
...
set_register_merging [get_cell io_out_c_*] FALSE
set_register_merging [get_cell io_out_b_*] FALSE
#link
